...
outputs/executables/main.out: computation/main.cpp computation/helpers/arr.h computation/helpers/print_array.h computation/algorithms/bubble_sort.h
	$(CXX) $(CXXFLAGS) computation/main.cpp computation/helpers/arr.cpp computation/helpers/print_array.cpp computation/algorithms/bubble_sort.cpp computation/algorithms/insertion_sort.cpp computation/algorithms/selection_sort.cpp -o outputs/executables/main.out
